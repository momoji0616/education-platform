...
--
-- Table structure for table `edu_exam`
--
...
--
-- Table structure for table `edu_exam_score`
--
...
--
-- Table structure for table `edu_forum_post`
--

DROP TABLE IF EXISTS `edu_forum_post`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `edu_forum_post` (
...
--
-- Table structure for table `edu_forum_read_state`
--

DROP TABLE IF EXISTS `edu_forum_read_state`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `edu_forum_read_state` (
...
--
-- Table structure for table `edu_forum_reply`
--
...
--
-- Table structure for table `edu_homework`
--
...
--
-- Table structure for table `edu_homework_submission`
--

DROP TABLE IF EXISTS `edu_homework_submission`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `edu_teacher_task`
--

DROP TABLE IF EXISTS `edu_teacher_task`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `edu_teacher_task` (
...
--
-- Table structure for table `edu_user_class_profile`
--

DROP TABLE IF EXISTS `edu_user_class_profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `edu_user_class_profile` (
  `user_id` bigint NOT NULL,
...
--
-- Table structure for table `rag_dataset`
--
...
CREATE TABLE `student_performance` (
  ...
  `Hours_Studied` int DEFAULT NULL,
  `Attendance` int DEFAULT NULL,
  `Parental_Involvement` varchar(50) DEFAULT NULL,
  `Access_to_Resources` varchar(50) DEFAULT NULL,
  `Extracurricular_Activities` varchar(50) DEFAULT NULL,
  `Sleep_Hours` int DEFAULT NULL,
  `Previous_Scores` int DEFAULT NULL,
  `Motivation_Level` varchar(50) DEFAULT NULL,
  `Internet_Access` varchar(50) DEFAULT NULL,
  `Tutoring_Sessions` int DEFAULT NULL,
  `Family_Income` varchar(50) DEFAULT NULL,
  `Teacher_Quality` varchar(50) DEFAULT NULL,
  `School_Type` varchar(50) DEFAULT NULL,
  `Peer_Influence` varchar(50) DEFAULT NULL,
  `Physical_Activity` int DEFAULT NULL,
  `Learning_Disabilities` varchar(50) DEFAULT NULL,
  `Parental_Education_Level` varchar(50) DEFAULT NULL,
  `Distance_from_Home` varchar(50) DEFAULT NULL,
  ...
  `class_name` varchar(50) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6608 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-02-23 11:20:17
